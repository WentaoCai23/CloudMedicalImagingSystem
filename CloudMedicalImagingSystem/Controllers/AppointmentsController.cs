...
using CloudMedicalImagingSystem.Models;

namespace CloudMedicalImagingSystem.Controllers
{
    public class AppointmentsController : Controller
    {
        private CMISModel db = new CMISModel();
        ...
        public ActionResult Create([Bind(Include = "Id,UserID,ExpertID,Date")] Appointment appointment)
        {
        ...
        */
        ...
        public String CreateAppointment()
        {
            ...
            var appointment = new Appointment
            {
                ...
                ExpertID = int.Parse(Request.Form["ExpertID"]),
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserID,ExpertID,Date")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
